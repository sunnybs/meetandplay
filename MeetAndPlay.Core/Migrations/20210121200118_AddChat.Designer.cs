...
namespace MeetAndPlay.Core.Migrations
{
    ...
    [Migration("20210121200118_AddChat")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MeetAndPlay.Data.Models.Chat.Chat", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MeetAndPlay.Data.Models.Chat.ChatUser", b =>
                {
            ...
            modelBuilder.Entity("MeetAndPlay.Data.Models.Chat.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MeetAndPlay.Data.Models.Chat.MessageReceivers", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MeetAndPlay.Data.Models.Offers.UserOfferPeriod", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("IsDayOfWeek")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsEveryday")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("MeetAndPlay.Data.Models.Users.UserFreePeriod", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MeetAndPlay.Data.Models.Chat.ChatUser", b =>
                {
                    b.HasOne("MeetAndPlay.Data.Models.Chat.Chat", null)
                        .WithMany("ChatUsers")
            ...
            modelBuilder.Entity("MeetAndPlay.Data.Models.Chat.Message", b =>
                {
                    b.HasOne("MeetAndPlay.Data.Models.Chat.Chat", "Chat")
                        .WithMany("Messages")
                        .HasForeignKey("ChatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MeetAndPlay.Data.Models.Chat.MessageReceivers", b =>
                {
                    b.HasOne("MeetAndPlay.Data.Models.Chat.Message", "Message")
                        .WithMany("Receivers")
